...
In addition, based on the findings in \noseeref{subsection:exploration-1-design-study-using-orthogonal-lap-joint}, the intention is to jump to variable-angle jap joints with the agenda to create a more architecturally relevant demonstrator. 
