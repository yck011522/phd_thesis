...
\begin{enumerate}
	...
	\begin{enumerate}
		...
		\item Demonstrated different possible architectural typologies, such as column grid structure \textit{(see \ul{5.4.4 Demonstrator Design - BusStop Pavilion})}, hut typology \seeref{subsection:exploration-4-demonstrator-design-hyparhut-pavilion} and prefabricated spatial frames \textit{(see \ul{8.4.3 Demonstrator Design  - CantiBox Pavilion})}.
